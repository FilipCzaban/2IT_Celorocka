...
const DB_COMPOSITIONS = [
  // STARS (ACS Reactions: The Chemistry of Fireworks - nPHegSuKe9Y)
    { id:1,  name:'Červená hvězda — Strontium',   cat:'stars',     catL:'Hvězdy',          hazard:'med', youtubeId:'nPHegSuKe9Y',
    ...
    { id:2,  name:'Zelená hvězda — Barium',       cat:'stars',     catL:'Hvězdy',          hazard:'high', youtubeId:'nPHegSuKe9Y',
    ...
    { id:3,  name:'Modrá hvězda — Měď/PVC',       cat:'stars',     catL:'Hvězdy',          hazard:'high', youtubeId:'nPHegSuKe9Y',
    ...
    { id:4,  name:'Bílá hvězda — Magnalium',      cat:'stars',     catL:'Hvězdy',          hazard:'med', youtubeId:'nPHegSuKe9Y',
    ...
    { id:5,  name:'Zlatá hvězda — Uhlíková',      cat:'stars',     catL:'Hvězdy',          hazard:'low', youtubeId:'nPHegSuKe9Y',
    ...
    { id:6,  name:'Stříbrná hvězda — Ti jiskry', cat:'stars',     catL:'Hvězdy',          hazard:'med', youtubeId:'nPHegSuKe9Y',
  ...
  // GLITTERS (ACS Reactions: The Chemistry of Fireworks - nPHegSuKe9Y)
    { id:7,  name:'Klasický Glitter — Antimony',  cat:'glitters',  catL:'Glittery',        hazard:'high', youtubeId:'nPHegSuKe9Y',
    ...
    { id:8,  name:'Barium Glitter — Zelenozlatý', cat:'glitters',  catL:'Glittery',        hazard:'high', youtubeId:'nPHegSuKe9Y',
      ...
      notes:'Toxické složky — barium i antimony. Používejte respirátor FFP3.' },

  // PRIMES (ACS Reactions: The Chemistry of Fireworks - nPHegSuKe9Y)
    { id:9,  name:'Prime — Černý prach',           cat:'primes',    catL:'Priming',         hazard:'med', youtubeId:'nPHegSuKe9Y',
    ...
    { id:10, name:'Hot Prime — Al/KClO₄',          cat:'primes',    catL:'Priming',         hazard:'high', youtubeId:'nPHegSuKe9Y',
  ...
  // BURST (ACS Reactions: The Chemistry of Fireworks - nPHegSuKe9Y)
    { id:11, name:'Burst charge — Granulovaný BP', cat:'burst',     catL:'Výbušné náplně',  hazard:'med', youtubeId:'nPHegSuKe9Y',
    ...
    { id:12, name:'Flash Prach — Záblesk/Zvuk',   cat:'burst',     catL:'Výbušné náplně',  hazard:'high', youtubeId:'nPHegSuKe9Y',
  ...
  // WHISTLE (ACS Reactions: The Chemistry of Fireworks - nPHegSuKe9Y)
    { id:13, name:'Whistle Mix — Benzoát',         cat:'whistle',   catL:'Whistle Mix',     hazard:'high', youtubeId:'nPHegSuKe9Y',
    ...
    { id:14, name:'Whistle Mix — Salicylát',       cat:'whistle',   catL:'Whistle Mix',     hazard:'high', youtubeId:'nPHegSuKe9Y',
  ...
  // ROCKETS (TED-Ed: The Deadly Irony of Gunpowder - cfQ934sR46Y)
    { id:15, name:'Raketové palivo — BKNO₃',      cat:'rockets',   catL:'Raketová paliva', hazard:'med', youtubeId:'cfQ934sR46Y',
      ...
      ing:[ {n:'Dusičnan draselný',p:65}, {n:'Uhlí airfloat',p:20}, {n:'Síra',p:10}, {nMENTION: 'Dextrin',p:5} ],
      notes:'Granulujte pro konzistentní tah. Testujte na malých vzorcích. Měřte specifický impuls.' },
    { id:16, name:'Raketové palivo — AP/HTPB',    cat:'rockets',   catL:'Raketová paliva', hazard:'high', youtubeId:'cfQ934sR46Y',
  ...
  // FOUNTAINS (ACS Reactions: How Do Sparklers Work? - J32Vd2gP4vI)
    { id:17, name:'Zlatá fontána — Fe hoblovačky', cat:'fountains', catL:'Fontány',         hazard:'low', youtubeId:'J32Vd2gP4vI',
    ...
    { id:18, name:'Titanová fontána — bílé jiskry',cat:'fountains', catL:'Fontány',         hazard:'med', youtubeId:'J32Vd2gP4vI',
    ...
    { id:19, name:'Zlatostříbrná fontána — Al/Fe', cat:'fountains', catL:'Fontány',         hazard:'med', youtubeId:'J32Vd2gP4vI',
  ...
  // FLARES (WIRED Pyrotechnician Answers Fireworks Questions - mS07p1Qj4yU)
    { id:20, name:'Červená flare — Signalizace',   cat:'flares',    catL:'Flares',          hazard:'med', youtubeId:'mS07p1Qj4yU',
    ...
    { id:21, name:'Zelená flare — Signalizace',    cat:'flares',    catL:'Flares',          hazard:'high', youtubeId:'mS07p1Qj4yU',
  ...
  // SMOKE (TED-Ed: The Deadly Irony of Gunpowder - cfQ934sR46Y)
    { id:22, name:'Červená dýmovnice',             cat:'smoke',     catL:'Dýmovnice',       hazard:'low', youtubeId:'cfQ934sR46Y',
    ...
    { id:23, name:'Modrá dýmovnice',               cat:'smoke',     catL:'Dýmovnice',       hazard:'low', youtubeId:'cfQ934sR46Y',
    ...
    { id:24, name:'Fialová dýmovnice',              cat:'smoke',     catL:'Dýmovnice',       hazard:'low', youtubeId:'cfQ934sR46Y',
  ...
  // SPARKLERS (ACS Reactions: How Do Sparklers Work? - J32Vd2gP4vI)
    { id:25, name:'Zlatá jiskrnice — Fe',           cat:'sparklers', catL:'Jiskrnice',       hazard:'low', youtubeId:'J32Vd2gP4vI',
    ...
    { id:26, name:'Stříbrná jiskrnice — MgAl',     cat:'sparklers', catL:'Jiskrnice',       hazard:'med', youtubeId:'J32Vd2gP4vI',
