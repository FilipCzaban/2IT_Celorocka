...
const DB_COMPOSITIONS = [
  // STARS
    { id:1,  name:'Červená hvězda — Strontium',   cat:'stars',     catL:'Hvězdy',          hazard:'med',
    ...
    { id:2,  name:'Zelená hvězda — Barium',       cat:'stars',     catL:'Hvězdy',          hazard:'high',
    ...
    { id:3,  name:'Modrá hvězda — Měď/PVC',       cat:'stars',     catL:'Hvězdy',          hazard:'high',
    ...
    { id:4,  name:'Bílá hvězda — Magnalium',      cat:'stars',     catL:'Hvězdy',          hazard:'med',
    ...
    { id:5,  name:'Zlatá hvězda — Uhlíková',      cat:'stars',     catL:'Hvězdy',          hazard:'low',
    ...
    { id:6,  name:'Stříbrná hvězda — Ti jiskry', cat:'stars',     catL:'Hvězdy',          hazard:'med',
    ...
    // GLITTERS
    { id:7,  name:'Klasický Glitter — Antimony',  cat:'glitters',  catL:'Glittery',        hazard:'high',
    ...
    { id:8,  name:'Barium Glitter — Zelenozlatý', cat:'glitters',  catL:'Glittery',        hazard:'high',
    ...
    // PRIMES
    { id:9,  name:'Prime — Černý prach',           cat:'primes',    catL:'Priming',         hazard:'med',
    ...
    // BURST
    { id:11, name:'Burst charge — Granulovaný BP', cat:'burst',     catL:'Výbušné náplně',  hazard:'med',
    ...
    { id:14, name:'Whistle Mix — Salicylát',       cat:'whistle',   catL:'Whistle Mix',     hazard:'high',
    ...
    // ROCKETS
    { id:15, name:'Raketové palivo — BKNO₃',      cat:'rockets',   catL:'Raketová paliva', hazard:'med',
    ...
    { id:16, name:'Raketové palivo — AP/HTPB',    cat:'rockets',   catL:'Raketová paliva', hazard:'high',
    ...
    // FOUNTAINS
    { id:17, name:'Zlatá fontána — Fe hoblovačky', cat:'fountains', catL:'Fontány',         hazard:'low',
    ...
    { id:18, name:'Titanová fontána — bílé jiskry',cat:'fountains', catL:'Fontány',         hazard:'med',
    ...
    { id:19, name:'Zlatostříbrná fontána — Al/Fe', cat:'fountains', catL:'Fontány',         hazard:'med',
      desc:'Kombinace zlatých (Fe) a stříbřitých (Al) jisker. Vizuálně atraktivní dvoubarevný efekt.',
    ...
    // FLARES
    { id:20, name:'Červená flare — Signalizace',   cat:'flares',    catL:'Flares',          hazard:'med',
    ...
    { id:21, name:'Zelená flare — Signalizace',    cat:'flares',    catL:'Flares',          hazard:'high',
    ...
    // SMOKE
    { id:22, name:'Červená dýmovnice',             cat:'smoke',     catL:'Dýmovnice',       hazard:'low',
    ...
    { id:23, name:'Modrá dýmovnice',               cat:'smoke',     catL:'Dýmovnice',       hazard:'low',
    ...
    { id:24, name:'Fialová dýmovnice',              cat:'smoke',     catL:'Dýmovnice',       hazard:'low',
    ...
    // SPARKLERS
    { id:25, name:'Zlatá jiskrnice — Fe',           cat:'sparklers', catL:'Jiskrnice',       hazard:'low',
