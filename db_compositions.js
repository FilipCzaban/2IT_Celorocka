...
const DB_COMPOSITIONS = [
  // STARS
    { id:1,  name:'Červená hvězda — Strontium',   cat:'stars',     catL:'Hvězdy',          hazard:'med', youtubeId:'S0T0jA67o4M',
    ...
    { id:2,  name:'Zelená hvězda — Barium',       cat:'stars',     catL:'Hvězdy',          hazard:'high', youtubeId:'q6g3tB6Vp90',
    ...
    { id:3,  name:'Modrá hvězda — Měď/PVC',       cat:'stars',     catL:'Hvězdy',          hazard:'high', youtubeId:'kYvV0vQy9gA',
    ...
    { id:4,  name:'Bílá hvězda — Magnalium',      cat:'stars',     catL:'Hvězdy',          hazard:'med', youtubeId:'Qf_cIu1q3qQ',
    ...
    { id:5,  name:'Zlatá hvězda — Uhlíková',      cat:'stars',     catL:'Hvězdy',          hazard:'low', youtubeId:'p4dFv4t5U44',
    ...
    { id:6,  name:'Stříbrná hvězda — Ti jiskry', cat:'stars',     catL:'Hvězdy',          hazard:'med', youtubeId:'kR2r-o01k8M',
      ...
      notes:'Titan skladujte odděleně od oxidátorů. Jiskry jsou intenzivní — vhodné vzdálenosti pro diváky.' },

    // GLITTERS
    { id:7,  name:'Klasický Glitter — Antimony',  cat:'glitters',  catL:'Glittery',        hazard:'high', youtubeId:'sR8C0h86Oas',
    ...
    { id:8,  name:'Barium Glitter — Zelenozlatý', cat:'glitters',  catL:'Glittery',        hazard:'high', youtubeId:'sR8C0h86Oas',
    ...
    // PRIMES
    { id:9,  name:'Prime — Černý prach',           cat:'primes',    catL:'Priming',         hazard:'med', youtubeId:'Zc2g0bQfLd8',
    ...
    { id:10, name:'Hot Prime — Al/KClO₄',          cat:'primes',    catL:'Priming',         hazard:'high', youtubeId:'Zc2g0bQfLd8',
    ...
    // BURST
    { id:11, name:'Burst charge — Granulovaný BP', cat:'burst',     catL:'Výbušné náplně',  hazard:'med', youtubeId:'Zc2g0bQfLd8',
    ...
    { id:12, name:'Flash Prach — Záblesk/Zvuk',   cat:'burst',     catL:'Výbušné náplně',  hazard:'high', youtubeId:'Zc2g0bQfLd8',
    ...
    // WHISTLE
    { id:13, name:'Whistle Mix — Benzoát',         cat:'whistle',   catL:'Whistle Mix',     hazard:'high', youtubeId:'5V56mYV-8Gk',
    ...
    { id:14, name:'Whistle Mix — Salicylát',       cat:'whistle',   catL:'Whistle Mix',     hazard:'high', youtubeId:'5V56mYV-8Gk',
    ...
    // ROCKETS
    { id:15, name:'Raketové palivo — BKNO₃',      cat:'rockets',   catL:'Raketová paliva', hazard:'med', youtubeId:'480W24O93tY',
    ...
    { id:16, name:'Raketové palivo — AP/HTPB',    cat:'rockets',   catL:'Raketová paliva', hazard:'high', youtubeId:'480W24O93tY',
    ...
    // FOUNTAINS
    { id:17, name:'Zlatá fontána — Fe hoblovačky', cat:'fountains', catL:'Fontány',         hazard:'low', youtubeId:'kR2r-o01k8M',
    ...
    { id:18, name:'Titanová fontána — bílé jiskry',cat:'fountains', catL:'Fontány',         hazard:'med', youtubeId:'kR2r-o01k8M',
    ...
    { id:19, name:'Zlatostříbrná fontána — Al/Fe', cat:'fountains', catL:'Fontány',         hazard:'med', youtubeId:'kR2r-o01k8M',
    ...
    // FLARES
    { id:20, name:'Červená flare — Signalizace',   cat:'flares',    catL:'Flares',          hazard:'med', youtubeId:'8q-w89u-sX8',
    ...
    { id:21, name:'Zelená flare — Signalizace',    cat:'flares',    catL:'Flares',          hazard:'high', youtubeId:'8q-w89u-sX8',
    ...
    // SMOKE
    { id:22, name:'Červená dýmovnice',             cat:'smoke',     catL:'Dýmovnice',       hazard:'low', youtubeId:'Z-w567q8p4M',
    ...
    { id:23, name:'Modrá dýmovnice',               cat:'smoke',     catL:'Dýmovnice',       hazard:'low', youtubeId:'Z-w567q8p4M',
    ...
    { id:24, name:'Fialová dýmovnice',              cat:'smoke',     catL:'Dýmovnice',       hazard:'low', youtubeId:'Z-w567q8p4M',
    ...
    // SPARKLERS
    { id:25, name:'Zlatá jiskrnice — Fe',           cat:'sparklers', catL:'Jiskrnice',       hazard:'low', youtubeId:'H748W0M9XQY',
    ...
    { id:26, name:'Stříbrná jiskrnice — MgAl',     cat:'sparklers', catL:'Jiskrnice',       hazard:'med', youtubeId:'H748W0M9XQY',
