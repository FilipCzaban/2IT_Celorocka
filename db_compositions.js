...
const DB_COMPOSITIONS = [
  // STARS (Spirit of '76: Peony / Strobe / Willow / Brocade Effects)
    ...
    { id:2,  name:'Zelená hvězda — Barium',       cat:'stars',     catL:'Hvězdy',          hazard:'high', youtubeId:'3lI7ezLc4bI',
    ...
    { id:3,  name:'Modrá hvězda — Měď/PVC',       cat:'stars',     catL:'Hvězdy',          hazard:'high', youtubeId:'3lI7ezLc4bI',
    ...
    { id:4,  name:'Bílá hvězda — Magnalium',      cat:'stars',     catL:'Hvězdy',          hazard:'med', youtubeId:'epzyLNuBuF0',
    ...
    { id:6,  name:'Stříbrná hvězda — Ti jiskry', cat:'stars',     catL:'Hvězdy',          hazard:'med', youtubeId:'u_p6nKGuKsc',
  ...
  // GLITTERS (Spirit of '76: Glitter & Strobe Effect - epzyLNuBuF0)
    ...
    { id:8,  name:'Barium Glitter — Zelenozlatý', cat:'glitters',  catL:'Glittery',        hazard:'high', youtubeId:'epzyLNuBuF0',
  ...
  // BURST (Display Shell Burst / Salute Explosion)
    { id:11, name:'Burst charge — Granulovaný BP', cat:'burst',     catL:'Výbušné náplně',  hazard:'med', youtubeId:'3lI7ezLc4bI',
    ...
    { id:12, name:'Flash Prach — Záblesk/Zvuk',   cat:'burst',     catL:'Výbušné náplně',  hazard:'high', youtubeId:'D5qvxNk6bsY',
  ...
  // WHISTLE (Whistling Firework Test - APRqm9xl7pY)
    { id:13, name:'Whistle Mix — Benzoát',         cat:'whistle',   catL:'Whistle Mix',     hazard:'high', youtubeId:'APRqm9xl7pY',
    ...
    { id:14, name:'Whistle Mix — Salicylát',       cat:'whistle',   catL:'Whistle Mix',     hazard:'high', youtubeId:'APRqm9xl7pY',
  ...
  // ROCKETS (Model Rocket Launches - -rlpFX1LiGg)
    { id:15, name:'Raketové palivo — BKNO₃',      cat:'rockets',   catL:'Raketová paliva', hazard:'med', youtubeId:'-rlpFX1LiGg',
      ...
      notes:'Granulujte pro konsistentní tah. Testujte na malých vzorcích. Měřte specifický impuls.' },
    { id:16, name:'Raketové palivo — AP/HTPB',    cat:'rockets',   catL:'Raketová paliva', hazard:'high', youtubeId:'-rlpFX1LiGg',
  ...
  // FOUNTAINS (Gold & Silver Fountains - 0l6Ebkp0ejQ)
    { id:17, name:'Zlatá fontána — Fe hoblovačky', cat:'fountains', catL:'Fontány',         hazard:'low', youtubeId:'0l6Ebkp0ejQ',
    ...
    { id:18, name:'Titanová fontána — bílé jiskry',cat:'fountains', catL:'Fontány',         hazard:'med', youtubeId:'0l6Ebkp0ejQ',
    ...
    { id:19, name:'Zlatostříbrná fontána — Al/Fe', cat:'fountains', catL:'Fontány',         hazard:'med', youtubeId:'0l6Ebkp0ejQ',
  ...
  // FLARES (Red road flare / Green Bengal light)
    { id:20, name:'Červená flare — Signalizace',   cat:'flares',    catL:'Flares',          hazard:'med', youtubeId:'JUkcOyy_WnQ',
  ...
  // SMOKE (Color Smoke Grenades - zI_tqrbmZoo)
    ...
    { id:23, name:'Modrá dýmovnice',               cat:'smoke',     catL:'Dýmovnice',       hazard:'low', youtubeId:'zI_tqrbmZoo',
    ...
    { id:24, name:'Fialová dýmovnice',              cat:'smoke',     catL:'Dýmovnice',       hazard:'low', youtubeId:'zI_tqrbmZoo',
  ...
  // SPARKLERS (Gold & Silver Sparklers - lsYjBet0rfU)
    { id:25, name:'Zlatá jiskrnice — Fe',           cat:'sparklers', catL:'Jiskrnice',       hazard:'low', youtubeId:'lsYjBet0rfU',
    ...
    { id:26, name:'Stříbrná jiskrnice — MgAl',     cat:'sparklers', catL:'Jiskrnice',       hazard:'med', youtubeId:'lsYjBet0rfU',
