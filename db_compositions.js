...
const DB_COMPOSITIONS = [
  // STARS
    ...
    { id:2,  name:'Zelená hvězda — Barium',       cat:'stars',     catL:'Hvězdy',          hazard:'high', youtubeId:'sxkNKOWiMzk',
  ...
  // BURST
    ...
    { id:12, name:'Flash Prach — Záblesk/Zvuk',   cat:'burst',     catL:'Výbušné náplně',  hazard:'high', youtubeId:'VlX2b_9f95E',
      ...
      notes:'⚠️⚠️ EXTRÉMNÉ NEBEZPEČNÉ. Max. 30 g. Jen 2 složky. Citlivý na tření, náraz, teplo a ESD.' },
