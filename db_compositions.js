...
const DB_COMPOSITIONS = [
  // STARS (ACS Reactions: The Chemistry of Fireworks - nPHegSulI_M)
    { id:1,  name:'Červená hvězda — Strontium',   cat:'stars',     catL:'Hvězdy',          hazard:'med', youtubeId:'nPHegSulI_M',
    ...
    { id:2,  name:'Zelená hvězda — Barium',       cat:'stars',     catL:'Hvězdy',          hazard:'high', youtubeId:'nPHegSulI_M',
    ...
    { id:3,  name:'Modrá hvězda — Měď/PVC',       cat:'stars',     catL:'Hvězdy',          hazard:'high', youtubeId:'nPHegSulI_M',
    ...
    { id:4,  name:'Bílá hvězda — Magnalium',      cat:'stars',     catL:'Hvězdy',          hazard:'med', youtubeId:'nPHegSulI_M',
    ...
    { id:5,  name:'Zlatá hvězda — Uhlíková',      cat:'stars',     catL:'Hvězdy',          hazard:'low', youtubeId:'nPHegSulI_M',
    ...
    { id:6,  name:'Stříbrná hvězda — Ti jiskry', cat:'stars',     catL:'Hvězdy',          hazard:'med', youtubeId:'nPHegSulI_M',
  ...
  // GLITTERS (Royal Institution: The Science of Fireworks - rmtK2BgmGCw)
    { id:7,  name:'Klasický Glitter — Antimony',  cat:'glitters',  catL:'Glittery',        hazard:'high', youtubeId:'rmtK2BgmGCw',
    ...
    { id:8,  name:'Barium Glitter — Zelenozlatý', cat:'glitters',  catL:'Glittery',        hazard:'high', youtubeId:'rmtK2BgmGCw',
  ...
  // PRIMES (TED-Ed: The Deadly Irony of Gunpowder - PrS4H5u_48E)
    { id:9,  name:'Prime — Černý prach',           cat:'primes',    catL:'Priming',         hazard:'med', youtubeId:'PrS4H5u_48E',
      desc:'Základní zápalná vrstva pro přenos ohně na hvězdy. Granulovaný nebo mokrý BP pokrývá hvězdu a zajiždí spolehlivý start hoření.',
    ...
    { id:10, name:'Hot Prime — Al/KClO₄',          cat:'primes',    catL:'Priming',         hazard:'high', youtubeId:'PrS4H5u_48E',
  ...
  // BURST (TED-Ed: The Deadly Irony of Gunpowder - PrS4H5u_48E)
    { id:11, name:'Burst charge — Granulovaný BP', cat:'burst',     catL:'Výbušné náplně',  hazard:'med', youtubeId:'PrS4H5u_48E',
    ...
    { id:12, name:'Flash Prach — Záblesk/Zvuk',   cat:'burst',     catL:'Výbušné náplně',  hazard:'high', youtubeId:'PrS4H5u_48E',
  ...
  // WHISTLE (Royal Institution: The Science of Fireworks - rmtK2BgmGCw)
    { id:13, name:'Whistle Mix — Benzoát',         cat:'whistle',   catL:'Whistle Mix',     hazard:'high', youtubeId:'rmtK2BgmGCw',
    ...
    { id:14, name:'Whistle Mix — Salicylát',       cat:'whistle',   catL:'Whistle Mix',     hazard:'high', youtubeId:'rmtK2BgmGCw',
  ...
  // ROCKETS (Warped Perception: See-Through Model Rocket Engine - _xvVJQSGHts)
    { id:15, name:'Raketové palivo — BKNO₃',      cat:'rockets',   catL:'Raketová paliva', hazard:'med', youtubeId:'_xvVJQSGHts',
    ...
    { id:16, name:'Raketové palivo — AP/HTPB',    cat:'rockets',   catL:'Raketová paliva', hazard:'high', youtubeId:'_xvVJQSGHts',
  ...
  // FOUNTAINS (ACS Reactions: How Do Sparklers Work? - wX-y0325990)
    { id:17, name:'Zlatá fontána — Fe hoblovačky', cat:'fountains', catL:'Fontány',         hazard:'low', youtubeId:'wX-y0325990',
    ...
    { id:18, name:'Titanová fontána — bílé jiskry',cat:'fountains', catL:'Fontány',         hazard:'med', youtubeId:'wX-y0325990',
    ...
    { id:19, name:'Zlatostříbrná fontána — Al/Fe', cat:'fountains', catL:'Fontány',         hazard:'med', youtubeId:'wX-y0325990',
  ...
  // FLARES (WikiHow: How to Operate Road Flares - h3srnTZB-Vw)
    { id:20, name:'Červená flare — Signalizace',   cat:'flares',    catL:'Flares',          hazard:'med', youtubeId:'h3srnTZB-Vw',
    ...
    { id:21, name:'Zelená flare — Signalizace',    cat:'flares',    catL:'Flares',          hazard:'high', youtubeId:'h3srnTZB-Vw',
  ...
  // SMOKE (NightHawkInLight: Smoke Waterfall & Combustion - 3QJBSo3HQAc)
    { id:22, name:'Červená dýmovnice',             cat:'smoke',     catL:'Dýmovnice',       hazard:'low', youtubeId:'3QJBSo3HQAc',
    ...
    { id:23, name:'Modrá dýmovnice',               cat:'smoke',     catL:'Dýmovnice',       hazard:'low', youtubeId:'3QJBSo3HQAc',
    ...
    { id:24, name:'Fialová dýmovnice',              cat:'smoke',     catL:'Dýmovnice',       hazard:'low', youtubeId:'3QJBSo3HQAc',
  ...
  // SPARKLERS (ACS Reactions: How Do Sparklers Work? - wX-y0325990)
    { id:25, name:'Zlatá jiskrnice — Fe',           cat:'sparklers', catL:'Jiskrnice',       hazard:'low', youtubeId:'wX-y0325990',
    ...
    { id:26, name:'Stříbrná jiskrnice — MgAl',     cat:'sparklers', catL:'Jiskrnice',       hazard:'med', youtubeId:'wX-y0325990',
